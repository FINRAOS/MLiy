...
ln -s "$MLIY_SOFTWARE/ldap/nss-pam-ldapd-0.9.7/nslcd/nslcd" /sbin/nslcd

ln -s "$MLIY_SOFTWARE/ldap/nss-pam-ldapd-0.9.7/nss/nss_ldap.so" /lib/libnss_ldap.so.2
ln -s /lib/libnss_ldap.so.2 /lib64/libnss_ldap.so.2

mkdir -p /lib/security
ln -s "$MLIY_SOFTWARE/ldap/nss-pam-ldapd-0.9.7/pam/pam_ldap.so" /lib/security/pam_ldap.so
...
echo "service nslcd restart" >> /etc/rc.d/rc.local
