...
i.e. 'Home Directory Size' or something")
	params = models.ManyToManyField('odapweb.Param', blank=True)
	compatible_instancetypes = models.ManyToManyField('odapweb.InstanceType')
...
def delete_bill(inst):
	logger = logging.getLogger("odapweb.views")
